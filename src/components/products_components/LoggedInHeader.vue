      ...
      <nav class="navbar navbar-expand-lg">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <div class="log-div d-flex me-4 p-1 gap-4">
                <i class="fa-regular fa-user mt-1" :class="light_mode ? 'header_mode_icon' : 'dark_header_mode_icon'"></i>
                <i class="fa-solid fa-bag-shopping mt-1" :class="light_mode ? 'header_mode_icon' : 'dark_header_mode_icon'"></i>
                ...
                <i class="fa-solid fa-arrow-right-from-bracket mt-1" :class="light_mode ? 'header_mode_icon' : 'dark_header_mode_icon'"></i>
            </div>
          </div>
      </nav>
    </div>
